...
releasecraft is a Ruby project for automation. It focuses on this technical goal: Classify changelog fragments into deterministic release sections.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 161, risk penalty 4, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
