"""Regression checks for the releasecraft casebook."""
...
from casebook.harness import assert_expected, releasecraft_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(releasecraft_summary(), assert_expected())
