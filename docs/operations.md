...
`releasecraft` is centered on automation work in Ruby. The technical target is: Classify changelog fragments into deterministic release sections.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 5.
